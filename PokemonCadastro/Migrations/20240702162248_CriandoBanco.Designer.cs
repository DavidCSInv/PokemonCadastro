...
namespace PokemonCadastro.Migrations
{
    ...
    [Migration("20240702162248_CriandoBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonCadastro.Model.PokemonOwnerJoin", b =>
                {
                    ...
                    b.Property<int?>("PokemonOwnerJoinOwnerId")
                        .HasColumnType("int");

                    b.Property<int?>("PokemonOwnerJoinPokemonId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PokemonOwnerJoinPokemonId", "PokemonOwnerJoinOwnerId");
            ...
            modelBuilder.Entity("PokemonCadastro.Model.PokemonModel", b =>
                {
                    b.HasOne("PokemonCadastro.Model.Owner", null)
                        .WithMany("Pokemons")
            ...
            modelBuilder.Entity("PokemonCadastro.Model.PokemonOwnerJoin", b =>
                {
                    ...
                    b.HasOne("PokemonCadastro.Model.Owner", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PokemonCadastro.Model.PokemonOwnerJoin", null)
                        .WithMany("PokemonOwners")
                        .HasForeignKey("PokemonOwnerJoinPokemonId", "PokemonOwnerJoinOwnerId");
